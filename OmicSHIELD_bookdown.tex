...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{require}\NormalTok{(}\StringTok{\textquotesingle{}DSI\textquotesingle{}}\NormalTok{)}
\FunctionTok{require}\NormalTok{(}\StringTok{\textquotesingle{}DSOpal\textquotesingle{}}\NormalTok{)}
\FunctionTok{require}\NormalTok{(}\StringTok{\textquotesingle{}dsBaseClient\textquotesingle{}}\NormalTok{)}
\FunctionTok{require}\NormalTok{(}\StringTok{\textquotesingle{}dsOmicsClient\textquotesingle{}}\NormalTok{)}

\NormalTok{builder }\OtherTok{\textless{}{-}}\NormalTok{ DSI}\SpecialCharTok{::}\FunctionTok{newDSLoginBuilder}\NormalTok{()}
\NormalTok{builder}\SpecialCharTok{$}\FunctionTok{append}\NormalTok{(}\AttributeTok{server =} \StringTok{"cohort1"}\NormalTok{, }\AttributeTok{url =} \StringTok{"https://opal{-}demo.obiba.org/"}\NormalTok{,}
               \AttributeTok{user =}  \StringTok{"dsuser"}\NormalTok{, }\AttributeTok{password =} \StringTok{"P@ssw0rd"}\NormalTok{,}
               \AttributeTok{driver =} \StringTok{"OpalDriver"}\NormalTok{, }\AttributeTok{profile =} \StringTok{"omics"}\NormalTok{)}
\NormalTok{logindata }\OtherTok{\textless{}{-}}\NormalTok{ builder}\SpecialCharTok{$}\FunctionTok{build}\NormalTok{()}
\NormalTok{conns }\OtherTok{\textless{}{-}}\NormalTok{ DSI}\SpecialCharTok{::}\FunctionTok{datashield.login}\NormalTok{(}\AttributeTok{logins =}\NormalTok{ logindata)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ds.table1D}\NormalTok{(}\StringTok{"pheno\_object$sex"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{counts}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ds.table1D}\NormalTok{(}\StringTok{"pheno\_object$diabetes\_diagnosed\_doctor"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{counts}
\end{Highlighting}
\end{Shaded}
...
\{\centering \includegraphics{OmicSHIELD_bookdown_files/figure-latex/singleCohortManhattan_plot-1}
...
{\centering \includegraphics{OmicSHIELD_bookdown_files/figure-latex/locuszoom-1} 
